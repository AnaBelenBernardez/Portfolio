export const SkillsData = [
  ...
  {
    name: "Postman",
    icon: <img src="/assets/postman-icon.svg" alt="postman" />,
  },
  {
    name: "Scrum",
    icon: <img src="\assets\scrum-svgrepo-com.svg" alt="scrum" />,
  },
  {
    name: "Git",
  ...
  {
    name: "Trello",
    icon: <i className="devicon-trello-plain-wordmark colored"></i>,
  },
  {
    name: "Canva",
